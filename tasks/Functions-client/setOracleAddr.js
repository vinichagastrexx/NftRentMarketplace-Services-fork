...
task(
  ...
  .setAction(async (taskArgs) => {
    ...
    console.log(
      `Setting oracle address to ${networks[network.name]["functionsOracleProxy"]} Functions client contract ${taskArgs.contract
      } on ${network.name}`
    )
    ...
    console.log(
      `\nUpdated oracle address to ${networks[network.name]["functionsOracleProxy"]} for Functions client contract ${taskArgs.contract
      } on ${network.name}`
    )
  })